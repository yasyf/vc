...
const ComponentNames = ['Discover', 'Filter', 'Search', 'List', 'Outreach', 'Intro', 'InvestorSettings', 'InvestorSignup', 'InvestorContacts', 'CompetitorPage', 'InvestorPage', 'CompanyPage'];
