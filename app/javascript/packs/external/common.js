...
const ComponentNames = ['Warmup', 'Discover', 'Filter', 'Search', 'List', 'Outreach', 'Intro', 'InvestorSettings', 'InvestorSignup', 'InvestorContacts', 'CompetitorPage', 'InvestorPage', 'CompanyPage'];
